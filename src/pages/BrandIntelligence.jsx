...
import { ArrowRight, Eye, Zap, Target, BarChart3, Play, Check } from 'lucide-react'
  ...
  const features = [
    {
      ...
      description: "Track brand mentions across social media, news, and web platforms with real-time alerts and sentiment analysis."
    },
    {
      icon: Zap,
      title: "Competitor Analysis",
      description: "Monitor competitor activities, campaigns, and strategies to stay ahead of the competition with AI-powered insights."
    },
    {
      icon: Target,
      title: "Sentiment Analysis",
      description: "Analyze public sentiment towards your brand and products with advanced natural language processing."
    },
    {
      icon: BarChart3,
      title: "Trend Intelligence",
      description: "Identify emerging trends and opportunities with AI-powered market analysis and predictive insights."
    }
  ]
              ...
              <div className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8">
                <div className="aspect-video bg-gradient-to-br from-purple-100 to-indigo-100 dark:from-purple-900/20 dark:to-indigo-900/20 rounded-lg flex items-center justify-center">
                  <div className="text-center">
                    <Eye className="w-16 h-16 text-purple-600 dark:text-purple-400 mx-auto mb-4" />
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Brand Intelligence</h3>
                    <p className="text-gray-600 dark:text-gray-300">Monitor & analyze your brand</p>
                  </div>
                </div>
              </div>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Everything you need to monitor and analyze your brand with artificial intelligence.
            </p>
          </motion.div>
      ...
      <section id="demo" className="py-20 bg-white dark:bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Watch how our AI monitors and analyzes your brand across all platforms.
            </p>
          </motion.div>
          ...
          >
            <Card className="glass dark:glass-dark shadow-modern overflow-hidden">
              <CardContent className="p-0">
                <div className="aspect-video bg-gradient-to-br from-purple-600 to-indigo-600 flex items-center justify-center relative overflow-hidden">
                  <motion.div
                    animate={{ 
                      background: [
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-6">
                Why Choose Brand Intelligence?
              </h2>
              <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
                Transform your brand monitoring with AI-powered intelligence tools that deliver insights.
              </p>
              ...
              <Card className="glass dark:glass-dark shadow-modern">
                <CardHeader>
                  ...
                  <CardDescription className="text-gray-600 dark:text-gray-400">
                    Start monitoring your brand with AI in minutes
                  </CardDescription>
                </CardHeader>
      ...
      <section id="pricing" className="py-20 bg-white dark:bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Choose the perfect plan for your brand intelligence needs.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                features: ["Up to 10,000 mentions/month", "Basic monitoring", "Email support", "Standard reports"]
              },
              {
                name: "Professional",
                price: "₹5,999",
                description: "Ideal for growing teams",
                features: ["Unlimited mentions", "Advanced monitoring", "Priority support", "Custom reports", "Competitor analysis"]
              },
              {
                name: "Enterprise",
                price: "₹19,999",
