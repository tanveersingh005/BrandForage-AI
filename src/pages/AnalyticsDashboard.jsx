...
import { ArrowRight, BarChart3, Zap, Target, TrendingUp, Play, Check } from 'lucide-react'
  ...
  const features = [
    {
      ...
      description: "Monitor your marketing performance in real-time with live dashboards and instant updates across all campaigns."
    },
    {
      icon: Zap,
      title: "Custom Reports",
      description: "Create personalized reports and dashboards tailored to your specific business needs and KPIs."
    },
    {
      icon: Target,
      title: "Predictive Analytics",
      description: "Get AI-powered predictions and insights to forecast trends and optimize your marketing strategy."
    },
    {
      icon: TrendingUp,
      title: "Performance Tracking",
      description: "Track ROI, conversion rates, and campaign effectiveness with detailed performance metrics."
    }
  ]
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-cyan-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto lg:mx-0">
                Get comprehensive insights into your marketing performance with real-time analytics, custom reports, and predictive analytics.
              </p>
            ...
            >
              <div className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8">
                <div className="aspect-video bg-gradient-to-br from-indigo-100 to-cyan-100 dark:from-indigo-900/20 dark:to-cyan-900/20 rounded-lg flex items-center justify-center relative overflow-hidden">
                  <motion.div
                    animate={{ 
                      background: [
                        "linear-gradient(45deg, #E0E7FF, #CFFAFE)",
                        "linear-gradient(45deg, #CFFAFE, #E0E7FF)",
                        "linear-gradient(45deg, #E0E7FF, #CFFAFE)"
                      ]
                    }}
                  ...
                  <motion.div
                    ...
                    className="absolute bottom-4 left-4 w-3 h-3 bg-cyan-400/30 rounded-full"
                  />
                </div>
              </div>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Everything you need to track and optimize your marketing performance with artificial intelligence.
            </p>
          </motion.div>
      ...
      <section id="demo" className="py-20 bg-white dark:bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">
              See Analytics Dashboard in Action
            </h2>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Watch how our analytics provide insights that drive your marketing success.
            </p>
          </motion.div>
          ...
          >
            <Card className="glass dark:glass-dark shadow-modern overflow-hidden">
              <CardContent className="p-0">
                <div className="aspect-video bg-gradient-to-br from-indigo-600 to-cyan-600 flex items-center justify-center relative overflow-hidden">
                  <motion.div
                    animate={{ 
                      background: [
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
                Transform your data into actionable insights with AI-powered analytics tools.
              </p>
              ...
              <Card className="glass dark:glass-dark shadow-modern">
                <CardHeader>
                  ...
                  <CardDescription className="text-gray-600 dark:text-gray-400">
                    Start analyzing your performance with AI in minutes
                  </CardDescription>
                </CardHeader>
            ...
            {[
              {
                ...
                features: ["Basic analytics", "Standard reports", "Email support", "5 dashboards"]
              },
              {
                name: "Professional",
                price: "₹5,999",
                description: "Ideal for growing teams",
                features: ["Advanced analytics", "Custom reports", "Priority support", "Unlimited dashboards", "Predictive insights"]
              },
              {
                name: "Enterprise",
                price: "₹19,999",
